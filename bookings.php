        ...
        <div class="container">
          ...
          <div class="footer-join">
            ...
            <a href="register.html" class="btn btn-primary"
              ><i class="feather-user-plus"></i> Join With Us</a
            >
          </div>
          <!-- /Footer Join -->
              ...
              <div class="col-lg-2 col-md-6">
                ...
                <div class="footer-widget footer-menu">
                  ...
                  <ul>
                    <li>
                      <a href="#"
                        ><img src="assets/img/icons/icon-apple.svg" alt="Icon"
                      /></a>
                    </li>
                    <li>
                      <a href="#"
                        ><img src="assets/img/icons/google-icon.svg" alt="Icon"
                      /></a>
                    </li>
                  </ul>
                </div>
              ...
              <div class="row align-items-center">
                <div class="col-md-6">
                  <div class="copyright-text">
                    <p class="mb-0">
                      &copy; 2023 DreamSports - All rights reserved.
                    </p>
                  </div>
                </div>
                <div class="col-md-6">
