...
try {
    ...
    if ($razorpayPaymentId) {
        ...
        if ($stmt->execute()) {
            ...
            sendSmsToAdmin($razorpayOrderId, $razorpayPaymentId, $courtId, $name, $email, $contact, $starttime, $endtime, $amount);
...
// Function to send SMS to admin using Twilio
function sendSmsToAdmin($orderID, $transactionID, $courtId, $name, $email, $contact, $starttime, $endtime, $amount)
{
